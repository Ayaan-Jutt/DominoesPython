...
class DominoDeck():
    def __init__(self):
        ...
        """
        #initialzie the circularQueue class and assign it with 28 dominoes
    ...
    def populate(self, useFile):
        ...
        if useFile:
            ...
            try:
                ...
                print("Cannot populate deck: invalid data in "+ testFile)
    ...
    def push(self, domino):
        ...
        if self.isEmpty():
            ...
            try:
                ...
                if domino.getTop() != self.items[-1].getTop() and domino.getBottom() != self.items[-1].getTop():
                ...
                domino.setTop(self.items[-1].getTop())
                #add the domino 
                self.items.append(domino)
            except Exception:
                pass
